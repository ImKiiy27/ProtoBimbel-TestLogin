...
class AdminController {
  ...
  public function dashboard(): void {
    ...
    $pendaftaran = $this->userModel->getPendaftaranTerbaru(10);
    $totalPendaftar = $this->userModel->countPendaftaran();
  ...
  public function user(): void {
    ...
    $users   = $this->userModel->getAllUsersWithDetail();
  ...
  private function handleCreateUser(): void {
    ...
    $result = $this->userModel->createUser([
      ...
      'mapel'    => $mapel,
      'kelas'    => $kelas,
      'nip'      => '',  // opsional, akan dibuat otomatis
      'nis'      => '',  // opsional, akan dibuat otomatis
    ]);
